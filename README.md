...
<table>
  ...
  <tr>
    <td width="50%">
      <h3>📈 Synergy</h3>
      <p>Real-time stock exchange simulator with sub-second updates handling <strong>300+ transactions</strong>. Admin dashboard that reduced oversight by 40%, and relational schemas in Supabase cutting data errors by 30%.</p>
