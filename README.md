...
public:
    ...
    string currently   = "Building CapTale — top-down pixel art RPG";
    string also_doing  = "Teaching Assistant for CS | Writing horror fiction";

    vector<string> interests = {
        "Game Development", "Full-Stack Web", "Systems Programming",
        "Creative Writing",  "Pixel Art"
    };
};
```
...
<table>
  <tr>
    <td width="50%">
      <h3>🎮 CapTale</h3>
      <p>Top-down pixel art RPG built from scratch in <strong>C++ / Raylib</strong>. Custom NPC dialogue systems, mini-game state machine, and a full interior/exterior world with hand-crafted assets.</p>
  ...
  <tr>
    ...
    <td width="50%">
      <h3>🚗 PakWheels Marketplace</h3>
      <p>OOP car marketplace simulation in <strong>C++</strong> with 32+ files. Inheritance hierarchies, operator overloading, friend classes, polymorphism, and dynamic casting.</p>
      <p><code>C++</code> <code>OOP</code> <code>Polymorphism</code></p>
    </td>
  </tr>
</table>
